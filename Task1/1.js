...
const temeratureC = parseInt(prompt("Введите температуру в градусах Цельсия."));
const temeratureF = Math.round((9 / 5) * temeratureC + 32);
alert(`Цельсий: ${temeratureC}, Фаренгейт: ${temeratureF}`);